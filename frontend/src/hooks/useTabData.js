...
const useTabData = () => {
  ...
  const [tabs, setTabStates] = useState({
    left: [{title: "top posts", content: "blah blah blah", visible: true, type: "viewer"}],
    central: [{title: "viewer", content: "you're a bum", visible: true, type: "viewer"}, {title: "editor", content: "balls", visible: false, type: "post"}],
    right: [{title: "top forums", content: "sineP", visible: true, type: "register"}]
  });
...
//pane here means name of pane
  ...
  const createNewTab = (pane, type = "viewer") => {
    ...
    setTabStates(prevTabs => ({
      ...
      [pane]: [
        ...
        {title: type, content: "You're Next", visible: true, type: type}
      ]
